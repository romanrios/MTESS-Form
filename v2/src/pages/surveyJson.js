export const surveyJson = {
  ...
  completedHtml: ` <div style="text-align: center;"> <h3>Formulario completado</h3> <p style="margin: 40px auto 80px auto;">Ya puedes exportarlo como PDF para imprimirlo o continuar editándolo.</p>`,
